...
if(phones.length === 0){
  ...
  noPhone.classList.add('d-none')
    ...
    phones.forEach( phone =>{
        ...
        <button  onclick="loadPhonesDetails('${phone.slug}')"  href="#" class= "btn btn-primary" data-bs-toggle="modal" data-bs-target="#phoneModal"  > Show Details </button>
          </div>
      </div>
    </div>
...
const displayPhoneDetails = phone =>{
  ...
  <p> Storage :${phone.mainFeatures.storage?phone.mainFeatures.storage:'No Storage'}
  <p> Others:${phone.other? phone.other.Bluetooth:'no Bluetooth'} </p>
